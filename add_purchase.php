                ...
                <div class="content-module-main cf">
                    ...
                    if (isset($_POST['supplier']) and isset($_POST['stock_name'])) {
                        ...
                        if ($validated_data === false) {
                            ...
                            $db->query("INSERT INTO stock_payment_entry (stock_id, payment) VALUES ('$stockid','$payment')");
                            ...
                            $msg = "<br><font color=green size=6px >PUuchase order Added successfully Ref: [" . $_POST['stockid'] . "] !</font>";
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <p><strong>Add Purchase Order </strong> - Add New ( Control +2)</p>
