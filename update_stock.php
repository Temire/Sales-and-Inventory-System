...
<head>
    <meta charset="utf-8">
    <title>SMS - Update Supplier</title>
        ...
        <div class="side-content fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-heading cf">
                    ...
                    <h3 class="fl">Update Stock Information</h3>
                ...
                <div class="content-module-main cf">
                    <form name="form1" method="post" id="form1" action="">
                        <p><strong>Stock Details </strong> - Add New ( Control + U)</p>
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            ...
                            if (isset($_POST['id'])) {
								...
								$uom = trim(mysqli_real_escape_string($db->connection, $_POST['uom']));


                                if ($db->query("UPDATE stock_details  SET stock_name ='$name',supplier_id='$supplier',company_price='$cost',selling_price='$sell',category='$Category',date='$date',uom='$uom'  where id=$id"))
                            ...
                            <tr>
                                <td>UOM:</td>
                                <td><input name="uom" placeholder="E.g pairs,cartons,boxes e.t.c." type="text" id="uom"
