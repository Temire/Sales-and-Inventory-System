                                ...
                                */
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
										...
										<td> <?php $uom = $db->queryUniqueValue("SELECT uom FROM stock_details WHERE stock_name='" . $row['stock_name'] . "'");
                                            echo $uom; ?></td>                                        
                                        <td>Total Amount: <?php echo $row['subtotal']; ?> || Balance: <?php echo $row['balance']; ?></td>
