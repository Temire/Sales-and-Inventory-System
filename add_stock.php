...
<head>
    <meta charset="utf-8">
    <title>SMS - Add Stock Category</title>
...
<div id="content">
                ...
                <div class="content-module-main cf">
                    ...
                    if (isset($_POST['name'])) {
                        ...
                        $gump->filter_rules(array(
							...
							'uom' => 'trim|sanitize_string|mysqli_escape'
                        ...
                        if ($validated_data === false) {
							...
							$uom = mysqli_real_escape_string($db->connection, $_POST['uom']);
                            ...
                            if ($count == 1) {
                                ...
                                if ($db->query("insert into stock_details(stock_id,stock_name,stock_quatity,supplier_id,company_price,selling_price,category,uom) values('$stockid','$name',0,'$supplier','$cost','$sell','$category','$uom')")) {
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><input name="name" placeholder="ENTER ITEM NAME" type="text" id="name"
                            ...
                            <tr>
                                <td>UOM:</td>
                                <td><input name="uom" placeholder="E.g pairs,cartons,boxes,pieces e.t.c." type="text" id="uom"
                                           maxlength="200" class="round default-width-input"
                                           value="<?php echo isset($uom) ? $uom : ''; ?>"/></td>
                            </tr>
    ...
    <!-- FOOTER -->
    <div id="footer">
        <p>Any Queries email to <a href="mailto:temireemmanuel@gmail.com?subject=Stock%20Management%20System">temireemmanuel@gmail.com</a>.
        </p>
